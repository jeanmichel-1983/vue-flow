...
declare global {
  ...
  const VueFlowApp: typeof import('./utils/vueFlowApp')['VueFlowApp']
  ...
  const createVueFlow: typeof import('./utils/vueFlowApp')['createVueFlow']
  ...
  const useDrag: typeof import('./composables/index')['useDrag']
  const useDraggable: typeof import('@vueuse/core')['useDraggable']
  const useDropZone: typeof import('@vueuse/core')['useDropZone']
  const useEdge: typeof import('./composables/useEdge')['default']
  const useEdgeHooks: typeof import('./composables/index')['useEdgeHooks']
